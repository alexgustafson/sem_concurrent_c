...
package com.yourcompany.field_manager_test;
...
//==============================================================================
public class field_manager_test   extends Activity
{
    //==============================================================================
    static
    {
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            field_manager_test.this.alertDismissed (callback, 0);
                        }
                    });
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            field_manager_test.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            field_manager_test.this.alertDismissed (callback, 2);
                        }
                    })
